...
function getIdTitle($title, $iNum) {
...
//Start of GitHub Feed as frontpage
if($rss !== false){
?>
...
<?php
    ...
    function createArtRows($rss){
        ...
        foreach($rss->entry as $item){
            ...
            $tId  = getIdTitle($item->title, $iNum);
        ?>
...
?>
            ...
            <p class='text-center'><?php echo (string) $rss->title.' '.date("m/d/Y H:i:s", strtotime((string) $rss->updated)) ?></p>

<?php

//End of GitHub Feed as frontpage
} else {
//Start of Alternative frontpage
?>
        <div class="jumbotron padOneEM" >
          <h2>The GitHub Atom Feed cannot be Obtained</h2>
            <p class="lead">This is most likely due to lack of internet access.</p>
        </div>
<?php
//End of Alternative frontpage
}
