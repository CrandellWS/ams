  ...
  <fieldset>
    ...
    <div id="productionSettings">
      <label>Domain:
        <div class="inLabel">
            <span class="inBlockRight"></span>
            <span class="inBlockLeft">http(s)://</span>
            <span class="blockOfHid">
                <input class="width100" type="text" name="proDomain" placeholder="localhost" value="">
            </span>
        </div>
        (Do Not Include http:// or https://)
      </label>
      ...
      <label>SEO Root Folder:
        <div class="inLabel">
            ...
            <span class="inBlockLeft">/</span>
            <span class="blockOfHid">
                <input class="width100" type="text" name="proDomain" placeholder="ams" value="">
            </span>
        </div>
        (blank if using root directoy)
      </label>
      <div class="clearSpace"></div>
